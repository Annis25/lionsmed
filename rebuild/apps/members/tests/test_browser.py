...
class MemberBrowserTests(StaticLiveServerTestCase):
    ...
    def test_lot2_pages(self):
        ...
        exp=AssociationExperience.objects.create(profile=user.member_profile,network='LEO',club='Club synthétique',function='Service associatif',start_year=2018,end_year=2019)
