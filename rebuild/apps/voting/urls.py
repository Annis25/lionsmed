...
urlpatterns = [
    ...
    path("votes/responsables/", views.manage_responsibles, name="manage_responsibles"),
    path("votes/responsables/<uuid:user_id>/", views.manage_responsible_toggle, name="manage_responsible_toggle"),
