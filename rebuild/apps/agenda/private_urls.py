...
urlpatterns = [
    ...
    path("calendrier/evenements/<uuid:event_id>/modifier/", v.calendar_event_edit, name="calendar_event_edit"),
    path("calendrier/evenements/<uuid:event_id>/annuler/", v.calendar_event_cancel, name="calendar_event_cancel"),
