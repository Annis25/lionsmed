...
class NewsArticleForm(StyledFields, forms.ModelForm):
    ...
    def __init__(self,*args,actor,**kwargs):
        ...
        if not can(actor,"news.edit" if instance else "news.create",instance):raise PermissionDenied
