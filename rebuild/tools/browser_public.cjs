...
(async()=>{
 ...
 const paths=['/','/notre-club/','/nos-actions/','/nos-actions/synthetic/','/evenements/','/evenements/synthetic/','/rejoindre/','/candidature/','/contact/','/mentions-legales/','/confidentialite/','/plan-du-site/'];
 ...
 for(const width of [1440,1280,1024,768,430,375])for(const [i,path] of ['/espace/contenu/','/espace/contenu/action/ajouter/','/espace/contenu/event/ajouter/'].entries())await check(path,width,14+i);
